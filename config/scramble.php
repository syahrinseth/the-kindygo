...
This is the API documentation for the KindyGo mobile application.
...
Tokens are issued with specific abilities that determine what actions they can perform:
- `profile:read` - Read user profile
- `profile:update` - Update user profile
- `children:read` - Read children data
- `invoices:read` - Read invoices
- `payments:create` - Create payments
- `payments:read` - Read payment history
- `notifications:read` - Read notifications
- `notifications:update` - Mark notifications as read
- `device-tokens:manage` - Manage device tokens for push notifications
- `tenants:read` - Read tenant information
- `tenants:switch` - Switch between tenants

## Multi-Tenancy

Users can belong to multiple tenants (companies). Use the tenant switch endpoint to change the current tenant context.
...
MARKDOWN,
    ...
    'ui' => [
         ...
         */
        'title' => 'KindyGo API Documentation',
